...
export default function LeftSideBar({ isSidebarOpen }: { isSidebarOpen: boolean, toggleSidebar: () => void }) {
  ...
  return (
      <div className="flex h-full">
            <Sidebar className="overflow-y-auto h-full">
              <SidebarMenu className='mt-5'>
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton onClick={() => setIsMessagingOpen(!isMessagingOpen)}>
                    <MessageSquareIcon className='mr-2' />메시징
                  </SidebarMenuButton>
                  {isMessagingOpen && (
                      <SidebarMenuSub>
                        <SidebarMenuSubItem>
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton onClick={() => setIsSettingsOpen(!isSettingsOpen)}>
                    <SettingsIcon className='mr-2' />설정
                  </SidebarMenuButton>
                  {isSettingsOpen && (
                      <SidebarMenuSub>
                        <SidebarMenuSubItem>
              ...
              <div className='mt-auto flex items-center p-4 border-t cursor-pointer'>
                <Avatar className='w-12 h-12 mr-3'/>
                <div>
                  <p className='font-bold'>이름</p>
                  <p className='text-sm text-gray-500'>이메일@example.com</p>
                </div>
              </div>
            </Sidebar>
