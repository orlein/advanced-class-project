        ...
        <Card className="w-full shadow-md">
          <CardHeader className="flex flex-col items-center py-8">
            ...
            {editingField === 'username' ? (
                ...
                <CardTitle className="text-3xl font-bold">{formData.username}</CardTitle>
            )}
          </CardHeader>
          <CardContent className="w-full p-8">
            ...
            <div className="mb-6 flex items-center justify-between">
              ...
              <button
                  className="p-2 rounded-full"
                  onClick={() => setEditingField(editingField === 'birthday' ? null : 'birthday')}>
                <PencilIcon className="h-6 w-6" />
              </button>
            </div>
            <div className="mb-6 flex items-center justify-between">
            ...
            <div className="mb-6 flex items-center justify-between">
              ...
              <button
                  className="p-2 rounded-full"
                  onClick={() => setEditingField(editingField === 'nationality' ? null : 'nationality')}>
                <PencilIcon className="h-6 w-6" />
              </button>
            </div>
            <div className="mb-6 flex items-center justify-between">
            ...
            <div className="mb-6 flex items-center justify-between">
              ...
              <button
                  className="p-2 rounded-full"
                  onClick={() => setEditingField(editingField === 'externalUrl' ? null : 'externalUrl')}>
                <PencilIcon className="h-6 w-6" />
              </button>
            </div>
            <div className="mb-6 flex items-center justify-between">
              ...
              <button
                  className="p-2 rounded-full"
                  onClick={() => setEditingField(editingField === 'interests' ? null : 'interests')}>
                <PencilIcon className="h-6 w-6" />
              </button>
            </div>
