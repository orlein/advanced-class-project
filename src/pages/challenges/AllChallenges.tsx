...
export default function AllChallenges() {
  ...
  return (
    <div className="w-full flex justify-center">
      <div className="w-full max-w-7xl flex flex-col gap-5 items-center">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-7 place-items-center">
          {challengeList && challengeList.map(challenge => <ChallengeCard challenge={challenge} />)}
        </section>
